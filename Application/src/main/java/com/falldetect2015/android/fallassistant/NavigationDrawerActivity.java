...
public class NavigationDrawerActivity extends Activity implements OptionAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.falldetect2015.android.fallassistant.R.layout.activity_navigation_drawer);

        mTitle = mDrawerTitle = getTitle();
        mOptionTitles = getResources().getStringArray(com.falldetect2015.android.fallassistant.R.array.options_array);
        mDrawerLayout = (DrawerLayout) findViewById(com.falldetect2015.android.fallassistant.R.id.drawer_layout);
        mDrawerList = (RecyclerView) findViewById(com.falldetect2015.android.fallassistant.R.id.left_drawer);

        // set a custom shadow that overlays the main content when the drawer opens
        mDrawerLayout.setDrawerShadow(com.falldetect2015.android.fallassistant.R.drawable.drawer_shadow, GravityCompat.START);
        // improve performance by indicating the list if fixed size.
        mDrawerList.setHasFixedSize(true);
        mDrawerList.setLayoutManager(new LinearLayoutManager(this));

        // set up the drawer's list view with items and click listener
        mDrawerList.setAdapter(new OptionAdapter(mOptionTitles, this));
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
                ...
                com.falldetect2015.android.fallassistant.R.drawable.ic_drawer,  /* nav drawer image to replace 'Up' caret */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.falldetect2015.android.fallassistant.R.menu.navigation_drawer, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case com.falldetect2015.android.fallassistant.R.id.action_websearch:
                ...
                if (intent.resolveActivity(getPackageManager()) != null) {
                    ...
                    Toast.makeText(this, com.falldetect2015.android.fallassistant.R.string.app_not_available, Toast.LENGTH_LONG).show();
                }
                return true;
            default:
    ...
    public static class OptionsFragment extends Fragment {
        ...
        public static Fragment newInstance(int position) {
            ...
            args.putInt(OptionsFragment.ARG_OPTIONS_NUMBER, position);
